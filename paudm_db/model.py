...
class Truth_Object(Base):
    ...
    mag_n01 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 01"),
    mag_n02 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 02"),
    mag_n03 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 03"),
    mag_n04 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 04"),
    mag_n05 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 05"),
    mag_n06 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 06"),
    mag_n07 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 07"),
    mag_n08 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 08"),
    mag_n09 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 09"),
    mag_n10 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 10"),
    mag_n11 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 11"),
    mag_n12 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 12"),
    mag_n13 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 13"),
    mag_n14 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 14"),
    mag_n15 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 15"),
    mag_n16 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 16"),
    mag_n17 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 17"),
    mag_n18 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 18"),
    mag_n19 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 19"),
    mag_n20 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 20"),
    mag_n21 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 21"),
    mag_n22 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 22"),
    mag_n23 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 23"),
    mag_n24 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 24"),
    mag_n25 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 25"),
    mag_n26 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 26"),
    mag_n27 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 27"),
    mag_n28 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 28"),
    mag_n29 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 29"),
    mag_n30 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 30"),
    mag_n31 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 31"),
    mag_n32 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 32"),
    mag_n33 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 33"),
    mag_n34 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 34"),
    mag_n35 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 35"),
    mag_n36 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 36"),
    mag_n37 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 37"),
    mag_n38 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 38"),
    mag_n39 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 39"),
    mag_n40 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 40"),
    mag_n41 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 41"),
    mag_n42 = Column(          Float(24),    nullable=False) #Truth simulated magnitude for PAU narrow filter 42"),
